        ...
        ScrollView {
            VStack(spacing: 0) {
                ...
                Group {
                    ...
                    if !paymentFormViewModel.isAmountValid { ValidationErrorText(text: "Please enter a valid amount")
                    }
                ...
                VStack(alignment: .leading) {
                    ...
                    HStack(spacing: 0) {
                        Button(action: {
                            paymentFormViewModel.type = .income
                        }) {
                            Text("Income")
                                .font(.headline)
                                .foregroundColor(paymentFormViewModel.type == .income ? Color.white : Color.primary)
                        }
                        .frame(minWidth: 0.0, maxWidth: .infinity)
                        .padding()
                        .background(paymentFormViewModel.type == .income ? Color("IncomeCard") : Color(.systemBackground))
                        
                        Button(action: {
                            paymentFormViewModel.type = .expense
                        }) {
                            Text("Expense")
                                .font(.headline)
                                .foregroundColor(paymentFormViewModel.type == .expense ? Color.white : Color.primary)
                        }
                        .frame(minWidth: 0.0, maxWidth: .infinity)
                        .padding()
...
struct PaymentFormView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        return Group {
            ...
            FormTextField(name: "NAME", placeHolder: "Enter your payment", value: .constant(""))
